...
public class Parcours {
    ...
    public Parcours() {
        ...
        this.positionDepart = new Point(Affichage.X + Affichage.LARGEUROVAL / 2,
                Affichage.Y - Affichage.LONGUEUROVAL / 2);
    ...
    public void createParcours() {
        ...
        while (x < Affichage.LARG + 50) {
            /**
             * x = x + r.nextInt(100); y = r.nextInt(200) + this.etat.getHauteur();
             */
            x = x + r.nextInt(longueurMaxLigne - longueurMinLigne) + 20;
            y = (r.nextInt(plage) + bordureMinLigne);
